...
inpTweets = csv.reader(open('/home/saurabh/Desktop/save/my_coding_algo/sed_file_final8.csv', 'rb'), delimiter=',', quotechar='|')
...
print NBClassifier
# Test the classifier
testTweet = 'this is really awefull and disgusting phone'
