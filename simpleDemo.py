...
inpTweets = csv.reader(open('/home/saurabh/Desktop/save/my_coding_algo/sed_file_final2.csv', 'rb'), delimiter=',', quotechar='|')
...
# Test the classifier
testTweet = 'awsome phone with so awsome features'
